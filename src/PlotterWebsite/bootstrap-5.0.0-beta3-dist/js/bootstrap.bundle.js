...
(function (global, factory) {
  ...
  const getSelector = element => {
    let selector = element.getAttribute('canvasData-bs-target');
  ...
  const getjQuery = () => {
    ...
    if (jQuery && !document.body.hasAttribute('canvasData-bs-no-jquery')) {
      return jQuery;
    }
  ...
  /**
   * --------------------------------------------------------------------------
   * Bootstrap (v5.0.0-beta3): dom/canvasData.js
   * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
   * --------------------------------------------------------------------------
   */
  ...
  const DATA_API_KEY$8 = '.canvasData-api';
  const SELECTOR_DISMISS = '[canvasData-bs-dismiss="alert"]';
  ...
  const DATA_API_KEY$7 = '.canvasData-api';
  const CLASS_NAME_ACTIVE$3 = 'active';
  const SELECTOR_DATA_TOGGLE$5 = '[canvasData-bs-toggle="button"]';
  ...
  const DATA_API_KEY$6 = '.canvasData-api';
  ...
  const SELECTOR_INDICATOR = '[canvasData-bs-target]';
  const SELECTOR_DATA_SLIDE = '[canvasData-bs-slide], [canvasData-bs-slide-to]';
  const SELECTOR_DATA_RIDE = '[canvasData-bs-ride="carousel"]';
  ...
  class Carousel extends BaseComponent {
    ...
    _setActiveIndicatorElement(element) {
      if (this._indicatorsElement) {
        ...
        for (let i = 0; i < indicators.length; i++) {
          if (Number.parseInt(indicators[i].getAttribute('canvasData-bs-slide-to'), 10) === this._getItemIndex(element)) {
    ...
    _updateInterval() {
      ...
      const elementInterval = Number.parseInt(element.getAttribute('canvasData-bs-interval'), 10);
    ...
    static dataApiClickHandler(event) {
      ...
      const slideIndex = this.getAttribute('canvasData-bs-slide-to');
  ...
  const DATA_API_KEY$5 = '.canvasData-api';
  const Default$7 = {
    toggle: true,
    parent: ''
  };
  ...
  const SELECTOR_DATA_TOGGLE$4 = '[canvasData-bs-toggle="collapse"]';
  /**
   * ------------------------------------------------------------------------
   * Class Definition
   * ------------------------------------------------------------------------
      ...
      if (this._parent) {
        actives = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter(elem => {
          if (typeof this._config.parent === 'string') {
            return elem.getAttribute('canvasData-bs-parent') === this._config.parent;
          }
  ...
  function effect$1(_ref2) {
    ...
    var _options$element = options.element,
        arrowElement = _options$element === void 0 ? '[canvasData-popper-arrow]' : _options$element;
  ...
  */
    ...
    return function createPopper(reference, popper, options) {
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate() {
          ...
          // is filled with the initial canvasData specified by the modifier. This means
          // it doesn't persist and is fresh on each update.
          // To ensure persistent canvasData, use `${name}#persistent`
      ...
      // cycle. This is useful when a modifier adds some persistent canvasData that
  ...
  const DATA_API_KEY$4 = '.canvasData-api';
  ...
  const SELECTOR_DATA_TOGGLE$3 = '[canvasData-bs-toggle="dropdown"]';
  ...
  const DATA_API_KEY$3 = '.canvasData-api';
  ...
  const SELECTOR_DATA_TOGGLE$2 = '[canvasData-bs-toggle="modal"]';
  const SELECTOR_DATA_DISMISS$2 = '[canvasData-bs-dismiss="modal"]';
  ...
  const DATA_API_KEY$2 = '.canvasData-api';
  ...
  const SELECTOR_DATA_DISMISS$1 = '[canvasData-bs-dismiss="offcanvas"]';
  const SELECTOR_DATA_TOGGLE$1 = '[canvasData-bs-toggle="offcanvas"]';
  /**
   * ------------------------------------------------------------------------
   * Class Definition
   * ------------------------------------------------------------------------
  ...
  /**
   * A pattern that matches safe canvasData URLs. Only matches image, video and audio types.
   *
   * Shoutout to Angular 7 https://github.com/angular/angular/blob/7.2.4/packages/core/src/sanitization/url_sanitizer.ts
   */
  ...
  class Tooltip extends BaseComponent {
    ...
    getTitle() {
      let title = this._element.getAttribute('canvasData-bs-original-title');
    ...
    _fixTitle() {
      ...
      const originalTitleType = typeof this._element.getAttribute('canvasData-bs-original-title');

      if (title || originalTitleType !== 'string') {
        this._element.setAttribute('canvasData-bs-original-title', title || '');
  ...
  class Popover extends Tooltip {
    ...
    _getContent() {
      return this._element.getAttribute('canvasData-bs-content') || this.config.content;
    }
  ...
  const DATA_API_KEY$1 = '.canvasData-api';
  const Default$1 = {
    offset: 10,
    method: 'auto',
    target: ''
  ...
  const SELECTOR_DATA_SPY = '[canvasData-bs-spy="scroll"]';
  ...
  const DATA_API_KEY = '.canvasData-api';
  ...
  const SELECTOR_DATA_TOGGLE = '[canvasData-bs-toggle="tab"], [canvasData-bs-toggle="pill"], [canvasData-bs-toggle="list"]';
  ...
  const SELECTOR_DATA_DISMISS = '[canvasData-bs-dismiss="toast"]';
  /**
   * ------------------------------------------------------------------------
   * Class Definition
   * ------------------------------------------------------------------------
